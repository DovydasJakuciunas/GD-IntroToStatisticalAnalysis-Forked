#' @title 
#' @description Common helper utilities for teaching and lab scripts: clear workspace/console, set working directory to the current script, load or require packages, and ensure output directories exist.
#' @author NMCG
#' @bugs None
#' @keywords utilities, teaching, labs, workflow, workspace, console, working directory, packages, install, require, directories, output folders
#' @seealso https://r4ds.hadley.nz/workflow-scripts.html
...
# ------------------------------------------------------------
clear_workspace_and_console <- function() {
